...
const Header = () => {
  ...
  return <header className="px-px gap-[16px] flex items-center justify-end pl-0 pr-[32px] py-[6px]">
      ...
      <Link to="/favoris" className="text-primary relative" aria-label="Mes favoris">
        ...
        {favoritesCount > 0 && <span className="absolute -top-2 -right-2 bg-accent text-accent-foreground text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center">
